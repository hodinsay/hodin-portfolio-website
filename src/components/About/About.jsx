        ...
        <article id='about'>
            ...
            <div className='about-flex-container'>
                <div>
                    ...
                    <p>I am a self-taught <strong>Software Engineer</strong> | <strong>Web Developer</strong> who build modern, responsive, and interactive user interface for websites and web applications with best practices and clean codes. Please take your time to check out some of my works under the <strong>Projects</strong> section.</p>
                    <br />
                    <p>I'm open to <strong>Job</strong> opportunities where I can contribute and learn in a team environment at a tech company with global reach. I will help build the frontend of websites and web applications that are the first thing people see when they want to interact with your product, leaving users with the best first impression of your business. If you have a good opportunity that matches my skills and experience, then please don't hesitate to <strong>Contact</strong> me.</p>
